...
var vTab= new Ext.TabPanel({
	activeTab: 0,           /*默认激活第一个TAB页*/
    animScroll: true,       /*使用动化滚动效果*/
    ...
    items: [{ id: 0, title: "主 页", frame: true, autoScroll: false}]
});
...
var IndexPage = Ext.extend(Ext.Viewport, {
	...
	center:{
			...
			margins: '0 5 5 0',
			border: false,
			html : '<iframe id="main" src="../purchase/stocklist.jsp" width="100%" height="100%" scrolling="auto" frameborder="0" ></iframe>'
	},
	south : {
			region : 'south',
			height : 30,
						...
						listeners : {
							...
							select : function(d, b, c) {
								if (d.value != "") {
									...
									iframe.src = "../purchase/stocklist.jsp";
								}
							}
						}
					}]
