...
public class Spxx implements java.io.Serializable {
	...
	/** full constructor */
	public Spxx(String spid, String spname, String xinghao, Integer lbid,
			String lbname, String dw, Double jhprice, Double chprice,
			Double scjj, Integer kcsl, Double kczj, Integer minnum,
			String csname, String state, String bz, Integer companyid) {
		this.spid = spid;
		this.spname = spname;
