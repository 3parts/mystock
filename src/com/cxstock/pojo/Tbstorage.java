...
public class Tbstorage implements java.io.Serializable {
	...
	/** full constructor */
	public Tbstorage(String vcNo, Integer gysId, String dtBs,
			String dtReceived, Double deShouldPayMoney,
			Double deActualPayMoney, Integer ipayState, Integer userId,
			String vcRemark, Integer companyId, Integer icbill, Integer fidel) {
		this.vcNo = vcNo;
		this.gysId = gysId;
		this.dtBs = dtBs;
